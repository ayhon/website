...
The code of this effort can be found [on
github](https://github.com/ayhon/sha3.rs). The implementation does not make use
of any loop unrolling or specific vectorized instructions, but it does
represent the Keccak permutation function's state using packed machine
